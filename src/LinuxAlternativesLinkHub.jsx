        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 lg:px-8">
          ...
          <nav className="hidden items-center gap-1 text-sm text-slate-300 md:flex">
            ...
            <div className="relative ml-1">
              ...
              {showQR && (
                <div className="absolute right-0 top-12 z-50 rounded-3xl border border-white/10 bg-slate-900 shadow-2xl shadow-black/40 p-5 w-64" onClick={e => e.stopPropagation()}>
                  <p className="text-sm font-semibold text-white mb-1">Scan to visit</p>
                  <p className="text-xs text-slate-400 mb-3">Point your phone camera at the QR code to open linuxchuck.com instantly.</p>
                  <div className="flex justify-center bg-white rounded-2xl p-3">
                    <img src="https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=https://www.linuxchuck.com&bgcolor=ffffff&color=000000&margin=2" alt="QR code for linuxchuck.com" width="180" height="180" style={{borderRadius:"8px"}} />
                  </div>
                  <p className="text-center text-xs text-slate-400 mt-3">linuxchuck.com</p>
                  <button
                  ...
                  <div key={server.name} className="rounded-2xl border border-white/10 bg-slate-900/80 overflow-hidden shadow-lg shadow-black/20 transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:shadow-xl flex flex-col">
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      <div className="mt-3 pt-2 border-t border-white/5">
                        <a href={server.site} target="_blank" rel="noreferrer" className="inline-flex rounded-lg border border-white/15 px-3 py-1 text-xs font-semibold transition hover:bg-white/5">
                          Official site →
                        </a>
                      </div>
                    </div>
